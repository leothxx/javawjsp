...
public class LifeCycle2 extends HttpServlet {
	...
	*/
	...
	public void initPostConstruct() {
		System.out.println("@@@@@@@@@@@이곳은 가장빠른 PostConstruct 어노테이션을 사용한 initPostConstruct() 메소드 입니다.@@@@@@@@@@");		
	}
	
	@PreDestroy
	public void destroyPreDestroy() {
		System.out.println("@@@@@@@@@@@이곳은 가장느린 PreDestroy 어노테이션을 사용한 destroyPreDestroy() 메소드 입니다.....@@@@@@@@@@");				
	}
}
