...
<head>
  ...
  <script>
  	'use strict';
  	function fCheck() {
  		//폼의 내용을 가져와서 유효성 검사를 실시함... (아이디/비밀번호/성명은 모두 20자 이하.)
	    ...
	    <table class="table">
	    	...
	    	<tr>
	    		<td colspan="2" style="text-align:center;">
	    			<input type="button" value="회원가입" onclick="fCheck()" class="btn btn-primary mr-3"/>
	    			<input type="reset" value="다시입력" class="btn btn-warning mr-3"/>
	    			<input type="button" value="돌아가기" onclick="location.href='${pageContext.request.contextPath}'/study/1120_Database/login.jsp;" class="btn btn-danger"/>
	    		</td>
	    	</tr>	
	    </table>
    </form>
