...
<head>
  ...
  <script>
  	...
  	function searchMid() {
  		...
  		location.href="${pageContext.request.contextPath}/work1120/SearchMid?mid="+mid;
  	}
  </script>
  <style>
  	img {
...
<body>
  ...
  <div class="container">
    ...
    <div><a href="${pageContext.request.contextPath}/work1120/MemberList" class="btn btn-warning form-control m-3">회원 전체 조회</a></div>
    <hr/>
    <div class="row">
	    <div class="col"><a href="${pageContext.request.contextPath}/work1120/LogOut" class="btn btn-success form-control">로그아웃</a></div>
    </div>
  </div>
  <p><br/></p>
</body>
