...
<jsp:setProperty property="age" name="vo"/> //필드명과 일치시켜야함. name은 어디서 가져올껀지 변수를 씀. vo에서 가져오니 vo property는 어떠한 값이니? 라는 개념으로 vo의 필드명과 일치시키면 된다.
<jsp:setProperty property="job" name="vo"/>
<jsp:setProperty property="address" name="vo"/> --%>

<jsp:setProperty property="*" name="vo"/> <!-- 별치면 vo에있는 필드명 다 가져온다. -->
