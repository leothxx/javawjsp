...
<head>
  ...
  <script>
    ...
    function updateCheck(idx, part, content) {
    	...
    	scheduleInput += '<span class="col"><input type="button" value="일정수정" onclick="scheduleUpdateOk('+idx+')" class="btn btn-primary form-control"/></span>';
    	scheduleInput += '<span class="col"><input type="button" value="수정창닫기" onclick="scheduleUpdateClose('+idx+')" class="btn btn-danger form-control"/></span>';
    	scheduleInput += '</span>';
    	scheduleInput += '</td></tr>';
    	scheduleInput += '</table>';
    	scheduleInput += '</form></div>';
    ...
    function scheduleUpdateOk(idx) {
    	let part = document.getElementById("part"+idx).value;
