...
<div class="container">
  ...
  <table class="table table-hover text-center">
    ...
    <c:forEach var="vo" items="${vos}">
    	<tr>
    	  <td>${searchCount}</td>
    	  <td class="text-left"><a href="${ctp}/boContent.bo?flag=search&idx=${vo.idx}&pag=${pag}&pageSize=${pageSize}&search=${search}&searchString=${searchString}" class="title">${vo.title}<c:if test="${vo.hour_diff <= 24}"><img src="${ctp}/images/new.gif"/></c:if></a></td>
    	  <td>${vo.nickName}</td>
...
<!-- 검색기 처리 끝 -->
<br/>
<div class="text-center"><a href="${ctp}/boList.bo?pag=${pag}&pageSize=${pageSize}" class="btn btn-info">돌아가기</a></div>
<p><br/></p>
